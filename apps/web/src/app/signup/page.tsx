    ...
    <div className="min-h-screen bg-background-primary flex flex-col">
        ...
        <div className="max-w-sm mx-auto w-full">
          ...
          <div className="text-center mb-12">
            ...
            <p className="text-text-muted text-sm text-center px-4">
              Sign up to track your workouts and connect with friends on your fitness journey.
            </p>
          </div>
          ...
          <div className="text-center mt-6">
            <p className="text-text-muted text-xs px-4">
              ...
              <Link href="/terms" className="text-accent-blue">
                Terms
              </Link>
              {', '}
              <Link href="/privacy" className="text-accent-blue">
                Privacy Policy
              </Link>
              {' and '}
              <Link href="/cookies" className="text-accent-blue">
                Cookies Policy
              </Link>
              .
            </p>
      ...
      <div className="border-t border-surface-border p-6">
        <div className="text-center">
          <span className="text-text-muted text-sm">Have an account? </span>
          <Link href="/login" className="text-accent-blue text-sm font-semibold">
            Log in
          </Link>
        </div>
      </div>
